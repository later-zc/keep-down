...
<img src="./assets/image-20230215003935643.png" alt="image-20230215003935643" />
...
> `body` 是 `form-data` 格式：
  ...
  <img src="./assets/image-20230215004111354.png" alt="image-20230215004111354" />

解析  `body` 中的数据，我们需要使用 `multer`：

- 安装 `@koa/multer`、`multer` 依赖：
...
<img src="./assets/image-20230216220056394.png" alt="image-20230216220056394" />



## 开启监听

<img src="./assets/image-20230216220155936.png" alt="image-20230216220155936" />



## 注册中间件

<img src="./assets/image-20230216220244806.png" alt="image-20230216220244806" />



## 监听回调

<img src="./assets/image-20230216220349542.png" alt="image-20230216220349542" />



## compose 方法

<img src="./assets/image-20230216220712347.png" alt="image-20230216220712347" />
...
从架构设计上来说：
  ...
  > **Koa 是简洁和自由的，它只包含最核心的功能**，并不会对我们使用其他中间件进行任何的限制，甚至是在 `app` 中连最基本的 `get`、`post` 都没有提供。
...
因为 express 和 Koa 框架他们的核心其实都是中间件：
  ...
  > 所以，接下来我们再来研究一下 `express` 和 `Koa` 中间件的执行顺序问题。
...
<img src="./assets/image-20230216193018674.png" alt="image-20230216193018674" />
